...
export async function fetchInventoryTransactionsByStoreManagerID(start_date, end_date, from_location, product_name, manager_ID) {
  try {
...
export async function acceptTransactionByStoreManager(transaction_ID) {
  try {
    const response = await fetch(`${API_URL}/transactions/accept-transaction-by-store-manager`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },

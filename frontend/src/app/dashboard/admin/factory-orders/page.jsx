...
export default function FactoryOrdersPage() {
  ...
  const [selectedProcessedStatus, setSelectedProcessedStatus] = useState("all");
  ...
  const fetchFactoryOrdersWrapper = async (start_date, end_date, salesman_name, product_name, processed_status) => {
    ...
    let processed_status_query = (processed_status === "all") ? "" : processed_status;
    ...
    console.log("Query Parameters:", {
      ...
      salesman_name_query,
      product_name_query,
      processed_status_query,
    });
    
    const factoryOrdersResponse = await fetchFactoryOrders(
      start_date_query,
      end_date_query,
      salesman_name_query,
      product_name_query,
    ...
    if (!factoryOrdersResponse.success) {
      console.error("Error fetching factory orders data:", factoryOrdersResponse.message);
      return;
    }

    // const factoryOrdersDdad = [
    //   {
    //     order_ID: "ORD001",
    ...
    // return factoryOrdersDdad;
    
    
    return factoryOrdersResponse.factory_orders;
  }
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select onValueChange={setSelectedProcessedStatus} value={selectedProcessedStatus}>
                  <SelectTrigger className="col-span-3 w-full">
                    <SelectValue placeholder="Select position" />
                  </SelectTrigger>
                  <SelectContent>
                    {
                      processed_status_types.map((facility_type) => (

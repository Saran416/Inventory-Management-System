...
import { fetchStockByEmployeeID } from "@/api/stock-calls";
...
export default function StockPage() {
  ...
  const fetchStockWrapper = async (product_name) => {
    ...
    const stockResponse = await fetchStockByEmployeeID(product_name_query, employeeID);
